...
<section class="aboutSec">
   ...
   <div class="row aboutBox">
       ...
       <div class="col span-3-of-3">
         ...
         <?php $image1 = get_field('my_image', 9); ?>
         <?php if(!empty($image1)) : ?>
      ...
      onmouseover=""   >
         <?php endif; ?>
          ...
          <p class="aboutP1"><?php the_field('first_paragraph', 9); ?> </p>

          <p class="aboutP2"><?php the_field('second_paragraph', 9); ?></p>

          <a  class="aboutmail" href="<?php the_field('email', 9); ?>" > email </a>
